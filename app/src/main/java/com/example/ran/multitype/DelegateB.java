...
@AdapterDelegate(DETAIL = @Type(CLASS = TestB.class, SUBTYPE = 0))
@DelegateLayout(LAYOUT = R.layout.activity_main)
public class DelegateB extends Delegate {

    public DelegateB(AbsDelegationAdapter adapter, int layoutId) {
